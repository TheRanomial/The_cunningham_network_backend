...
export const deployErc20Tool = {
    ...
    handler: async (args) => {
        try {
            ...
            console.log("Deploying contract...", args.name, args.symbol);
            ...
            console.error("An error occurred during contract deployment:", error.message || error);
            throw new Error(`Failed to deploy ${args.name} (${args.symbol}) token. Please check the logs for details.`);
        }
    },
};
