export {};
/*mport type { Chain, Network, TokenId } from "@wormhole-foundation/sdk";
import {
  TokenTransfer,
  Wormhole,
  amount,
...
import { getSigner, waitLog } from "./wormhole/helpers/helpers.js";
import { tokenTransfer } from "./wormhole/helpers/tokenTransfer.js";
...
(async function () {
  ...
  const val = destination.signer;
  console.log("address is",val);
