...
import { z } from "zod";
export class GetNftCollectionStatisticsParametersSchema extends createToolParameters(z.object({
    collectionSlug: z.string(),
})) {
}
export class GetNftSalesParametersSchema extends createToolParameters(z.object({
    collectionSlug: z.string(),
})) {
}
