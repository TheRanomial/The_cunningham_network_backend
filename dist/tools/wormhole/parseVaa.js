import { UniversalAddress, createVAA, deserialize, serialize, encoding, serializeLayout, deserializeLayout, } from "@wormhole-foundation/sdk";
(async function () {
    // EXAMPLE_PARSE_VAA
    ...
    const fakeVaaBytes = serialize(createVAA("Uint8Array", {
        guardianSet: 0,
        timestamp: 0,
        nonce: 0,
        emitterChain: "Solana",
    ...
    const tokenBridgeVaaBytes = serialize(createVAA("TokenBridge:Transfer", {
        guardianSet: 0,
        timestamp: 0,
        nonce: 0,
        emitterChain: "Solana",
    ...
    const customVaaBytes = serialize(createVAA("Uint8Array", {
        guardianSet: 0,
        timestamp: 0,
        nonce: 0,
        emitterChain: "Solana",
