...
const cosmwasm = {
    ...
    getChain: (network, chain, overrides) => new _cosmwasm.CosmwasmChain(chain, new _cosmwasm.CosmwasmPlatform(network, applyChainsConfigConfigOverrides(network, _cosmwasm._platform, {
        [chain]: overrides,
    }))),
};
