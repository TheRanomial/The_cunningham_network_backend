...
exports.TensorService = void 0;
const core_1 = require("@goat-sdk/core");
const web3_js_1 = require("@solana/web3.js");
let TensorService = (() => {
    let _instanceExtraInitializers = [];
    let _getNftInfo_decorators;
    let _getBuyListingTransaction_decorators;
    return class TensorService {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _getNftInfo_decorators = [(0, core_1.Tool)({
            ...
            __esDecorate(this, null, _getNftInfo_decorators, { kind: "method", name: "getNftInfo", static: false, private: false, access: { has: obj => "getNftInfo" in obj, get: obj => obj.getNftInfo }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async getBuyListingTransaction(walletClient, parameters) {
            ...
            const versionedTransaction = web3_js_1.VersionedTransaction.deserialize(Buffer.from(txV0.data));
...
exports.TensorService = TensorService;
