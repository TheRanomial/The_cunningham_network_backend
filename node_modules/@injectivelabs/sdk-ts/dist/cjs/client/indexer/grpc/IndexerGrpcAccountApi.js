...
class IndexerGrpcAccountApi extends BaseIndexerGrpcConsumer_js_1.default {
    constructor(endpoint) {
        super(endpoint);
        this.module = index_js_1.IndexerModule.Account;
    ...
    fetchRewards(_a) {
        return __awaiter(this, arguments, void 0, function* ({ address, epoch }) {
    ...
    fetchSubaccountHistory(_a) {
        return __awaiter(this, arguments, void 0, function* ({ subaccountId, denom, transferTypes = [], pagination, }) {
    ...
    fetchSubaccountOrderSummary(_a) {
        return __awaiter(this, arguments, void 0, function* ({ subaccountId, marketId, orderDirection, }) {
