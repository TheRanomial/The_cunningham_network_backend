...
class IndexerGrpcOracleApi extends BaseIndexerGrpcConsumer_js_1.default {
    constructor(endpoint) {
        super(endpoint);
        this.module = index_js_1.IndexerModule.Oracle;
    ...
    fetchOraclePrice(_a) {
        return __awaiter(this, arguments, void 0, function* ({ baseSymbol, quoteSymbol, oracleScaleFactor, oracleType, }) {
