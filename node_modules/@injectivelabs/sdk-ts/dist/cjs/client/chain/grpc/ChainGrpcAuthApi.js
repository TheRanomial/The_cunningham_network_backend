...
class ChainGrpcAuthApi extends BaseGrpcConsumer_js_1.default {
    constructor(endpoint) {
        super(endpoint);
        this.module = index_js_1.ChainModule.Auth;
    ...
    fetchAccount(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.Account(request, this.metadata));
    ...
    fetchAccounts(pagination) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.Accounts(request, this.metadata));
