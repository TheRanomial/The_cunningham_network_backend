...
class ChainGrpcIbcApi extends BaseGrpcConsumer_js_1.default {
    constructor(endpoint) {
        super(endpoint);
        this.module = index_js_1.ChainModule.Ibc;
    ...
    fetchDenomTrace(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.hash = hash;
            try {
                const response = yield this.retry(() => this.client.DenomTrace(request, this.metadata));
    ...
    fetchDenomsTrace(pagination) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.DenomTraces(request, this.metadata));
