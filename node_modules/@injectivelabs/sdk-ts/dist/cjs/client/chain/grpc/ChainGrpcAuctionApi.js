...
class ChainGrpcAuctionApi extends BaseGrpcConsumer_js_1.default {
    constructor(endpoint) {
        super(endpoint);
        this.module = index_js_1.ChainModule.Auction;
    ...
    fetchModuleParams() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.AuctionParams(request, this.metadata));
    ...
    fetchModuleState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.AuctionModuleState(request, this.metadata));
    ...
    fetchCurrentBasket() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.CurrentAuctionBasket(request, this.metadata));
