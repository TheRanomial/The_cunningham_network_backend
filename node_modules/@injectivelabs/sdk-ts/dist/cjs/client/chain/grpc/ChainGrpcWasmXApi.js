...
class ChainGrpcWasmXApi extends BaseGrpcConsumer_js_1.default {
    ...
    fetchModuleParams() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.WasmxParams(request, this.metadata));
                return response;
            }
            catch (e) {
    ...
    fetchModuleState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.WasmxModuleState(request, this.metadata));
