...
class ChainGrpcMintApi extends BaseGrpcConsumer_js_1.default {
    constructor(endpoint) {
        super(endpoint);
        this.module = index_js_2.ChainModule.Mint;
    ...
    fetchInflation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.Inflation(request, this.metadata));
                return {
    ...
    fetchAnnualProvisions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.AnnualProvisions(request, this.metadata));
                return {
