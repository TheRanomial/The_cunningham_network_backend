...
class ChainGrpcGovApi extends BaseGrpcConsumer_js_1.default {
    constructor(endpoint) {
        super(endpoint);
        this.module = index_js_1.ChainModule.Gov;
    ...
    fetchModuleParams() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const responses = yield Promise.all(requests.map((request) => this.client.Params(request, this.metadata)));
    ...
    fetchProposals(_a) {
        return __awaiter(this, arguments, void 0, function* ({ status, pagination, }) {
            ...
            try {
                const response = yield this.retry(() => this.client.Proposals(request, this.metadata));
    ...
    fetchProposal(proposalId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.retry(() => this.client.Proposal(request, this.metadata));
    ...
    fetchProposalDeposits(_a) {
        return __awaiter(this, arguments, void 0, function* ({ proposalId, pagination, }) {
            ...
            try {
                const response = yield this.retry(() => this.client.Deposits(request, this.metadata));
    ...
    fetchProposalVotes(_a) {
        return __awaiter(this, arguments, void 0, function* ({ proposalId, pagination, }) {
            ...
            try {
                const response = yield this.retry(() => this.client.Votes(request, this.metadata));
    ...
    fetchProposalTally(proposalId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.proposalId = proposalId.toString();
            try {
                const response = yield this.retry(() => this.client.TallyResult(request, this.metadata));
