...
class ChainGrpcGovTransformer {
    static moduleParamsResponseToModuleParams(response) {
        ...
        return {
            ...
            tallyParams: {
                quorum: (0, index_js_1.uint8ArrayToString)((params === null || params === void 0 ? void 0 : params.quorum) || '0'),
                threshold: (0, index_js_1.uint8ArrayToString)((params === null || params === void 0 ? void 0 : params.threshold) || '0'),
                vetoThreshold: (0, index_js_1.uint8ArrayToString)((params === null || params === void 0 ? void 0 : params.vetoThreshold) || '0'),
            },
        };
    }
