...
class ChainRestBankApi extends BaseRestConsumer_js_1.default {
     ...
     */
    fetchBalances(address_1) {
        return __awaiter(this, arguments, void 0, function* (address, params = {}) {
     ...
     * @param address address of account to look up
     */
    fetchBalance(address_1, denom_1) {
        return __awaiter(this, arguments, void 0, function* (address, denom, params = {}) {
            const endpoint = `cosmos/bank/v1beta1/balances/${address}`;
            try {
                const response = yield this.retry(() => this.get(endpoint, params));
    ...
    fetchDenomOwners(denom_1) {
        return __awaiter(this, arguments, void 0, function* (denom, params = {}) {
