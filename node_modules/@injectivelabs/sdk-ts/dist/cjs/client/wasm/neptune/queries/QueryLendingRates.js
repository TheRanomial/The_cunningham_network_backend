...
class QueryGetAllLendingRates extends BaseWasmQuery_js_1.BaseWasmQuery {
    toPayload() {
        const payload = {
            get_all_lending_rates: Object.assign(Object.assign({}, (this.params.limit !== undefined ? { limit: this.params.limit } : {})), (this.params.startAfter ? { start_after: this.params.startAfter } : {})),
        };
