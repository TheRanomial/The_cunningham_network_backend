...
class MsgPrivilegedExecuteContract extends MsgBase_js_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgPrivilegedExecuteContract' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.exchange.v1beta1.MsgPrivilegedExecuteContract' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {
