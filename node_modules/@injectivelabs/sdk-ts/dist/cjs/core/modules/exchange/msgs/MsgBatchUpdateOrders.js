    ...
    toProto() {
        ...
        if (params.spotOrdersToCreate && params.spotOrdersToCreate.length > 0) {
            const orderData = params.spotOrdersToCreate.map((args) => {
                const paramsFromArgs = Object.assign(Object.assign({}, args), { price: (0, numbers_js_1.amountToCosmosSdkDecAmount)(args.price).toFixed(), triggerPrice: (0, numbers_js_1.amountToCosmosSdkDecAmount)(args.triggerPrice || 0).toFixed(), quantity: (0, numbers_js_1.amountToCosmosSdkDecAmount)(args.quantity).toFixed() });
        ...
        if (params.derivativeOrdersToCreate &&
            ...
            const orderData = params.derivativeOrdersToCreate.map((args) => {
                const paramsFromArgs = Object.assign(Object.assign({}, args), { price: (0, numbers_js_1.amountToCosmosSdkDecAmount)(args.price).toFixed(), margin: (0, numbers_js_1.amountToCosmosSdkDecAmount)(args.margin).toFixed(), triggerPrice: (0, numbers_js_1.amountToCosmosSdkDecAmount)(args.triggerPrice || 0).toFixed(), quantity: (0, numbers_js_1.amountToCosmosSdkDecAmount)(args.quantity).toFixed() });
