...
class MsgCreateDerivativeLimitOrder extends MsgBase_js_1.MsgBase {
    ...
    toProto() {
        ...
        const params = Object.assign(Object.assign({}, initialParams), { price: (0, numbers_js_1.amountToCosmosSdkDecAmount)(initialParams.price).toFixed(), margin: (0, numbers_js_1.amountToCosmosSdkDecAmount)(initialParams.margin).toFixed(), triggerPrice: (0, numbers_js_1.amountToCosmosSdkDecAmount)(initialParams.triggerPrice || 0).toFixed(), quantity: (0, numbers_js_1.amountToCosmosSdkDecAmount)(initialParams.quantity).toFixed() });
