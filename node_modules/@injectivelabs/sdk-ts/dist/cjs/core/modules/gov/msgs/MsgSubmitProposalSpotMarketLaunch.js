...
class MsgSubmitProposalSpotMarketLaunch extends MsgBase_js_1.MsgBase {
    ...
    toProto() {
        ...
        const content = createSpotMarketLaunchContent(Object.assign(Object.assign({}, params), { market: Object.assign(Object.assign({}, params.market), { minPriceTickSize: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.minPriceTickSize).toFixed(), minQuantityTickSize: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.minQuantityTickSize).toFixed(), makerFeeRate: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.makerFeeRate).toFixed(), takerFeeRate: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.takerFeeRate).toFixed(), minNotional: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.minNotional).toFixed() }) }));
