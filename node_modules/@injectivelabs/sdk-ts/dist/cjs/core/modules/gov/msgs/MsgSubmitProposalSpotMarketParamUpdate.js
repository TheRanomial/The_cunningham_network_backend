...
class MsgSubmitProposalSpotMarketParamUpdate extends MsgBase_js_1.MsgBase {
    ...
    toProto() {
        ...
        const content = createSpotMarketParamUpdate(Object.assign(Object.assign({}, params), { market: Object.assign(Object.assign({}, params.market), { relayerFeeShareRate: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.relayerFeeShareRate).toFixed(), makerFeeRate: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.makerFeeRate).toFixed(), takerFeeRate: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.takerFeeRate).toFixed(), minQuantityTickSize: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.minQuantityTickSize).toFixed() }) }));
