...
class MsgSubmitProposalPerpetualMarketLaunch extends MsgBase_js_1.MsgBase {
    ...
    toProto() {
        ...
        const content = createPerpetualMarketLaunch(Object.assign(Object.assign({}, params), { market: Object.assign(Object.assign({}, params.market), { initialMarginRatio: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.initialMarginRatio).toFixed(), maintenanceMarginRatio: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.maintenanceMarginRatio).toFixed(), makerFeeRate: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.makerFeeRate).toFixed(), takerFeeRate: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.takerFeeRate).toFixed(), minQuantityTickSize: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.minQuantityTickSize).toFixed(), minNotional: (0, numbers_js_1.amountToCosmosSdkDecAmount)(params.market.minNotional).toFixed() }) }));
