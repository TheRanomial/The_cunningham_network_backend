...
class MsgCreateNamespace extends MsgBase_js_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.permissions.v1beta1.MsgCreateNamespace' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.permissions.v1beta1.MsgCreateNamespace' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {
