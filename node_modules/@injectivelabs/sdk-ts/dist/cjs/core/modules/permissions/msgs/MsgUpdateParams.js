...
class MsgUpdateParams extends MsgBase_js_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.permissions.v1beta1.MsgUpdateParams' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.permissions.v1beta1.MsgUpdateParams' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {
