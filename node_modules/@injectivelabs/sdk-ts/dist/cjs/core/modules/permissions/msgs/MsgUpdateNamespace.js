...
class MsgUpdateNamespace extends MsgBase_js_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.permissions.v1beta1.MsgUpdateNamespace' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.permissions.v1beta1.MsgUpdateNamespace' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {
