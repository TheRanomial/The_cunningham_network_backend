...
class MsgChangeAdmin extends MsgBase_js_1.MsgBase {
    ...
    toData() {
        ...
        return Object.assign({ '@type': '/injective.tokenfactory.v1beta1.MsgChangeAdmin' }, proto);
    }
    toAmino() {
        const proto = this.toProto();
    ...
    toWeb3() {
        ...
        const { value } = amino;
        return Object.assign({ '@type': '/injective.tokenfactory.v1beta1.MsgChangeAdmin' }, value);
    }
    toDirectSign() {
        const proto = this.toProto();
        return {
