...
class TxRestApi {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const timeout = (options === null || options === void 0 ? void 0 : options.timeout) ||
                new utils_1.BigNumberInBase((options === null || options === void 0 ? void 0 : options.txTimeout) || utils_1.DEFAULT_BLOCK_TIMEOUT_HEIGHT)
                    ...
                    .toNumber();
            try {
                const { tx_response: txResponse } = yield this.broadcastTx(tx, tx_rest_client_js_1.BroadcastMode.Sync);
    ...
    broadcastBlock(tx) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.broadcastTx(tx, tx_rest_client_js_1.BroadcastMode.Block);
            try {
                const { tx_response: txResponse } = response;
                if (txResponse.code !== 0) {
                    throw new exceptions_1.TransactionException(new Error(txResponse.raw_log), {
    ...
    broadcastTx(txRaw_1) {
        return __awaiter(this, arguments, void 0, function* (txRaw, mode = tx_rest_client_js_1.BroadcastMode.Sync) {
