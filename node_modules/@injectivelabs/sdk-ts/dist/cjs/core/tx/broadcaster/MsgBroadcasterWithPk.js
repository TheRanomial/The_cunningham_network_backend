...
class MsgBroadcasterWithPk {
     ...
     */
    broadcast(transaction, accountDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { txRaw } = yield this.prepareTxForBroadcast(transaction, accountDetails);
    ...
    broadcastWithFeeDelegation(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transactionApi = new index_js_4.IndexerGrpcWeb3GwApi(endpoints.indexer);
            ...
            return yield new TxGrpcApi_js_1.TxGrpcApi(endpoints.grpc).fetchTxPoll(response.txHash);
        });
    }
    /**
     * Broadcasting the transaction using the client
     ...
     * @returns {string} transaction hash
     */
    simulate(transaction, accountDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            /** Block Details */
            const timeoutHeight = yield this.getTimeoutHeight();
            ...
            const simulationResponse = yield new TxGrpcApi_js_1.TxGrpcApi(endpoints.grpc).simulate(txRaw);
    ...
    getTxWithStdFee(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stdGasFee = (0, utils_1.getStdFee)(Object.assign(Object.assign({}, args.fee), { gas: new utils_1.BigNumberInBase(result.gasInfo.gasUsed)
                    ...
                    .toFixed() }));
            return (0, tx_js_1.createTransaction)(Object.assign(Object.assign({}, args), { fee: stdGasFee }));
        });
    }
    /**
    ...
    prepareTxForBroadcast(transaction, accountDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            /** Block Details */
            const timeoutHeight = yield this.getTimeoutHeight();
            const gas = (((_a = transaction.gas) === null || _a === void 0 ? void 0 : _a.gas) || (0, msgs_js_1.getGasPriceBasedOnMessage)(msgs)).toString();
            /** Prepare the Transaction * */
    ...
    getAccountDetails(accountDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (useRest) {
                ...
                const accountDetailsResponse = yield new index_js_3.ChainRestAuthApi(endpoints.grpc).fetchAccount(privateKey.toBech32());
            ...
            const { privateKey, endpoints } = this;
            const accountDetailsResponse = yield new index_js_2.ChainGrpcAuthApi(endpoints.grpc).fetchAccount(privateKey.toBech32());
    ...
    getTimeoutHeight() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (useRest) {
                const latestBlock = yield new index_js_3.ChainRestTendermintApi(endpoints.grpc).fetchLatestBlock();
                const latestHeight = latestBlock.header.height;
                return new utils_1.BigNumberInBase(latestHeight).plus(txTimeout);
            }
            const latestBlock = yield new index_js_2.ChainGrpcTendermintApi(endpoints.grpc).fetchLatestBlock();
            const latestHeight = latestBlock.header.height;
            return new utils_1.BigNumberInBase(latestHeight).plus(txTimeout);
        });
    }
    broadcastTxRaw(txRaw) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const txResponse = yield new TxGrpcApi_js_1.TxGrpcApi(endpoints.grpc).broadcast(txRaw, {
                txTimeout,
            });
