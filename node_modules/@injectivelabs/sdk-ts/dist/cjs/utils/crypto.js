...
const SHA256_js_1 = require("jscrypto/SHA256.js");
const RIPEMD160_js_1 = require("jscrypto/RIPEMD160.js");
const Base64_js_1 = require("jscrypto/Base64.js");
const jscrypto_1 = require("jscrypto");
const secp256k1 = __importStar(require("secp256k1"));
const eth_sig_util_1 = require("@metamask/eth-sig-util");
const hashToHex = (data) => {
    return SHA256_js_1.SHA256.hash(Base64_js_1.Base64.parse(data)).toString().toUpperCase();
};
exports.hashToHex = hashToHex;
const sha256 = (data) => {
    return SHA256_js_1.SHA256.hash(new jscrypto_1.Word32Array(data)).toUint8Array();
};
exports.sha256 = sha256;
const ripemd160 = (data) => {
    return RIPEMD160_js_1.RIPEMD160.hash(new jscrypto_1.Word32Array(data)).toUint8Array();
};
