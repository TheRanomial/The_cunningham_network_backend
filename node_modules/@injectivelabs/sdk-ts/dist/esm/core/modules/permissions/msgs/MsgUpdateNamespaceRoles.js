...
export default class MsgUpdateNamespaceRoles extends MsgBase {
    ...
    toProto() {
        ...
        return InjectivePermissionsV1Beta1Tx.MsgUpdateNamespaceRoles.fromPartial(message);
    }
    toData() {
    ...
    toBinary() {
        return InjectivePermissionsV1Beta1Tx.MsgUpdateNamespaceRoles.encode(this.toProto()).finish();
    }
}
