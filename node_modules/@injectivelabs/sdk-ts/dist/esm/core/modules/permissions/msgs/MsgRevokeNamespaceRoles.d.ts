...
export default class MsgRevokeNamespaceRoles extends MsgBase<MsgRevokeNamespaceRoles.Params, MsgRevokeNamespaceRoles.Proto> {
    ...
    toData(): {
        sender: string;
        namespaceDenom: string;
        addressRolesToRevoke: import("@injectivelabs/core-proto-ts/cjs/injective/permissions/v1beta1/permissions.js").AddressRoles[];
        '@type': string;
    };
    toAmino(): {
        type: string;
        value: {
            ...
            address_roles_to_revoke: import("@injectivelabs/core-proto-ts/cjs/injective/permissions/v1beta1/permissions.js").AddressRoles[];
        };
    };
    toWeb3(): {
        sender: string;
