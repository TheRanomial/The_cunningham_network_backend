...
export default class MsgRevokeNamespaceRoles extends MsgBase {
    ...
    toProto() {
        ...
        return InjectivePermissionsV1Beta1Tx.MsgRevokeNamespaceRoles.fromPartial(message);
    }
    toData() {
    ...
    toBinary() {
        return InjectivePermissionsV1Beta1Tx.MsgRevokeNamespaceRoles.encode(this.toProto()).finish();
    }
}
