...
exports.AddressVoucher = exports.Voucher = exports.RoleIDs = exports.Role = exports.AddressRoles = exports.Namespace = exports.Action = exports.protobufPackage = void 0;
...
exports.Namespace = {
    encode: function (message, writer) {
        ...
        try {
            for (var _c = __values(message.rolePermissions), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
                exports.Role.encode(v, writer.uint32(50).fork()).ldelim();
            }
        }
        ...
        try {
            for (var _e = __values(message.addressRoles), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
                exports.AddressRoles.encode(v, writer.uint32(58).fork()).ldelim();
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.addressRoles.push(exports.AddressRoles.decode(reader, reader.uint32()));
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            ...
            addressRoles: Array.isArray(object === null || object === void 0 ? void 0 : object.addressRoles)
                ? object.addressRoles.map(function (e) { return exports.AddressRoles.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.addressRoles) {
            obj.addressRoles = message.addressRoles.map(function (e) { return e ? exports.AddressRoles.toJSON(e) : undefined; });
        }
        else {
            obj.addressRoles = [];
        }
    ...
    fromPartial: function (object) {
        ...
        message.rolePermissions = ((_f = object.rolePermissions) === null || _f === void 0 ? void 0 : _f.map(function (e) { return exports.Role.fromPartial(e); })) || [];
        message.addressRoles = ((_g = object.addressRoles) === null || _g === void 0 ? void 0 : _g.map(function (e) { return exports.AddressRoles.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.AddressRoles = {
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_js_1.default.Reader ? input : new minimal_js_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseAddressRoles();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create: function (base) {
        return exports.AddressRoles.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseAddressRoles();
...
exports.Voucher = {
    ...
    fromJSON: function (object) {
        return { coins: Array.isArray(object === null || object === void 0 ? void 0 : object.coins) ? object.coins.map(function (e) { return coin_1.Coin.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.coins) {
...
exports.AddressVoucher = {
    encode: function (message, writer) {
        ...
        if (message.voucher !== undefined) {
            exports.Voucher.encode(message.voucher, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.voucher = exports.Voucher.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            address: isSet(object.address) ? String(object.address) : "",
            voucher: isSet(object.voucher) ? exports.Voucher.fromJSON(object.voucher) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.address !== undefined && (obj.address = message.address);
        message.voucher !== undefined && (obj.voucher = message.voucher ? exports.Voucher.toJSON(message.voucher) : undefined);
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.voucher = (object.voucher !== undefined && object.voucher !== null)
            ? exports.Voucher.fromPartial(object.voucher)
            : undefined;
        return message;
    },
};
