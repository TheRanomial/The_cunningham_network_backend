...
(function (TokenTransfer) {
    ...
    async function lookupDestinationToken(srcChain, dstChain, token) {
        ...
        if (lookup.chain === dstChain.chain) {
            ...
            if ((0, sdk_definitions_1.canonicalAddress)({ chain: dstChain.chain, address: destWrappedNative }) === (0, sdk_definitions_1.canonicalAddress)({ chain: dstChain.chain, address: nativeAddress })) {
